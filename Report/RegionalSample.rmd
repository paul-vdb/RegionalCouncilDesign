...
kable(tab, caption = "Number of sample locations on the 8-km grid by PCL/non-PCL.", booktabs = TRUE)
```


```{r fig1,echo = FALSE, warning = FALSE,messages = FALSE,fig.cap="Southland Region Example of the 8-km grid which yields 494 sites.", fig.height=7, fig.width=7}
...
```{r fig2,echo = FALSE, warning = FALSE,messages = FALSE,fig.cap="Southland Region Example of the Master Sample matching sample size as the 8-km grid.",fig.height=7, fig.width=7}
...
```{r tabpos, echo = FALSE, warning = FALSE}
	...
	kable(tab.pos, col.names = c("Year", "High Immigration", "Low Immigration", "Total"), caption = "Design option that is proposed by @gormleywarburton.", booktabs = TRUE)
```
